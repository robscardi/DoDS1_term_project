...
def main():
    ...
    modexp:ModulusExponential = OctalMethod(BlakleyMethod(BlakleyModulus()))
    ...
    b = int("b3fc92111676e77368df192fb4d1de2130288dcf05f30f786cd9aa71e313f0fc",256)
    n = int("cc19aafd739949c1c0f0ad9349c7e55f62a7933bc410b2ab1a1ec897bb315b85",256)
    a = int("0012d526d29b710cf425f010af234dfcc237d091ef733864575fd8a05faf9511",256)
    '''
