# Generate random tests for the modulus multiplication module 
...
parser = argparse.ArgumentParser(description="create tests file (modulus multiplication) for the 2024 AY Design of Digital System 1 teaching @NTNU RSA accelerator project")
